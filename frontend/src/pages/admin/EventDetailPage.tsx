...
import { CollaboratorsList } from "@/components/admin/CollaboratorsList";
...
export function EventDetailPage() {
  ...
  const { data: collaborators } = useQuery({
    ...
    queryFn: () => collaboratorsApi.list(eventId!),
    enabled: !!eventId,
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          {!event.is_owner && (
            <span className="text-xs bg-purple-100 text-purple-700 font-medium px-2 py-1 rounded-full">Shared with me</span>
          )}
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <h2 className="text-sm font-semibold text-gray-700 mb-4">Co-admins</h2>
          <CollaboratorsList
            eventId={eventId!}
